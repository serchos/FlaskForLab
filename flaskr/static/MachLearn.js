...
var e = document.getElementById("TabList");
var currentTable = e.options[e.selectedIndex].text;
if (currentTable != 'Выберите базу прецедентов')
{
    $("#main_part").attr("hidden",false);
}
